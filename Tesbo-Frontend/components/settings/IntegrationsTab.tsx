      ...
      <Card className="p-4 space-y-4">
        ...
        {PROVIDERS.map((provider) => {
          ...
          return (
            <div
              key={provider.id}
              className="rounded-lg border border-[var(--border)] p-4 flex items-start gap-4"
            >
              <div className="shrink-0 w-10 h-10 rounded-lg flex items-center justify-center bg-[var(--brand-primary)]">
                {provider.icon}
              </div>
