...
test.describe("invitations", () => {
  ...
  test("an owner can invite a QA engineer and the invite is listed as pending", async () => {
  ...
  test("a manager can only invite QA engineers", async () => {
  ...
  test("nobody can invite an owner, not even the owner", async () => {
  ...
  test("a QA engineer cannot invite anyone", async () => {
  ...
  test("an invitation needs a well-formed email address", async () => {
  ...
  test("a second invite to the same address is refused and points at the existing one", async () => {
  ...
  test("an invitation scoped to a project outside the workspace is refused", async () => {
    const res = await asOwner.post("/api/workspace/invitations", {
      data: {
  ...
  test("the public invite lookup describes the invitation without leaking a way to redeem it", async () => {
  ...
  test("an unknown or malformed token fails cleanly, never with a 500", async () => {
    const tokens = [
      "not-a-token",
      "0".repeat(64),
      "%20",
  ...
  test("an invited user joins the workspace with the role they were granted", async () => {
  ...
  test("an invitation scoped to a project grants access to exactly that project", async () => {
  ...
  test("the invited address is matched case-insensitively", async () => {
  ...
  test("an invitation cannot be accepted by a different account", async () => {
  ...
  test("an accepted invitation cannot be used twice", async () => {
  ...
  test("an expired invitation is reported as expired and cannot be accepted", async () => {
  ...
  test("resending an invitation invalidates the token it replaces", async () => {
  ...
  test("only pending invitations can be resent or cancelled", async () => {
  ...
  test("a manager cannot cancel or resend an invitation somebody else sent", async () => {
  ...
  test("an invitation from another workspace is invisible, not merely unusable", async () => {
  ...
  test("listing invitations sweeps overdue ones into expired", async () => {
  ...
  test("registering from an invitation creates the account and joins the workspace", async () => {
  ...
  test("registering from an invitation enforces a name and a real password", async () => {
  ...
  test.describe("staged registration over OTP", () => {
    ...
    test("the password flow creates the account, joins the workspace and signs the user in", async () => {
    ...
    test("the passwordless flow creates an account that has no password to guess", async () => {
    ...
    test("verifying without starting is refused, even with a valid code", async () => {
    ...
    test("a wrong or expired code leaves no account behind", async () => {
    ...
    test("a code issued for one invite cannot complete another", async () => {
    ...
    test("the staged flows validate the name and password before sending a code", async () => {
    ...
    test("a cancelled invite cannot be registered against", async () => {
    ...
    test("the staged flows refuse an address that already has an account", async () => {
  ...
  test("registering against an address that already has an account is refused", async () => {
